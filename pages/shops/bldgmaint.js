...
import StackedBarGraph from "../../components/stackedchart";
  ...
  return (
    <Layout>
      <div className={styles.container}>
        <Head>
          <title>Building Maintenance Shop KSI Report</title>
        </Head>

        <main className={styles.main}>
          <h1 className={styles.title}>Building Maintenance</h1>
        ...
        {/* <StackedBarGraph options={TimeAnalysisObj} /> */}
